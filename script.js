...
const translations = {
  da: {
    ...
    bookPhone: "Book tid på 71 69 19 25",
    seeServices: "Se ydelser",
    quickBookingAria: "Hurtig booking",
    nextCut: "Næste klip",
    callBook: "Ring og book direkte",
    bookingText: "Fortæl hvilken behandling du ønsker, så finder vi en tid der passer.",
    callNow: "Ring nu",
    ...
    priceNote: "Med og uden bestillingstider. Ring for at booke eller høre om ledige tider.",
    ...
    footerBook: "Book tid: 71 69 19 25",
  },
  en: {
    ...
    bookPhone: "Book at 71 69 19 25",
    seeServices: "See services",
    quickBookingAria: "Quick booking",
    nextCut: "Next cut",
    callBook: "Call and book directly",
    bookingText: "Tell us which treatment you want, and we will find a time that fits.",
    callNow: "Call now",
    ...
    priceWash: "Wash",
    priceFringe: "Fringe",
    priceNote: "With and without appointments. Call to book or ask about available times.",
    ...
    footerBook: "Book now: 71 69 19 25",
  },
};
